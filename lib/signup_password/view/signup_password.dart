...
import 'package:yalla/signup_password/view/signup_password.dart';
...
class SignupPasswordScreen extends StatefulWidget
{
  ...
  SignupPasswordScreen(this.receivedMessage);
                    ...
                    child: Center(
                      child: TextField(
                        onChanged: (name) {
                          ...
                          if(isConfirmPasswordAvailable && isPasswordAvailable && isNameAvailable) {
                          ...
                          if(isNameAvailable && isPasswordAvailable && isConfirmPasswordAvailable && isPasswordMatch) {
                            isButtonActive = true;
                            setState(() {
                    ...
                    child: Center(
                      child: TextField(
                        onChanged: (password) {
                          ...
                          if(isConfirmPasswordAvailable && isPasswordAvailable) {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if(isButtonActive)
                      {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => VerificationCodeScreen(widget.receivedMessage)),
                        );
                      }
                      else
                      {
