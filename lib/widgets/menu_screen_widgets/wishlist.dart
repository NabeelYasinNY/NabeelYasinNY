    ...
    return Stack(
      children: [
        CustomAlignUI(
          ...
          topPadding: ResponsiveUtil.calculateTopPosition(context, 415),
          ...
          child: DropShadowWidget(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: () {
                  NavigationUtil.navigateToEmptyWishlistScreen(context);
                },
                borderRadius: BorderRadius.circular(10),
                child: Container(),
              ),
        ...
        PositionedIconWidget(
          ...
          topPadding: ResponsiveUtil.calculateTopPosition(context, 433),
